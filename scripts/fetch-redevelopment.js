...
const STAGE_MAP = [
  ...
  { key: '재공람',     idx: 0 }, { key: '구의회의견청취', idx: 0 },
  { key: '모니터링',   idx: -2 }, { key: '정비예정', idx: -2 }, { key: '관심구역',  idx: -2 },
  { key: '준비단계',   idx: -1 }, { key: '준비위결성',idx: -1 },
  // 신속통합기획 후보지(정비사업 정보몽땅 크롤링) 전용 초기 단계 — 정비구역
  // 지정(idx 0) 이전에 있는 자문/후보지 선정/신통기획 착수 단계라 별도 분류.
  { key: '자문',       idx: -1 }, { key: '후보지선정', idx: -1 },
  { key: '신통 착수',  idx: -1 }, { key: '신통착수',  idx: -1 },
  { key: '신통 통보',  idx: -1 }, { key: '심의요청',  idx: -1 },
];
